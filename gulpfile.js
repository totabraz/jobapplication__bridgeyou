...
var sass_bootstrap_in = './bower_components/bootstrap/dist/**/*';
var sass_bootstrap_out = './dist/vendors-external/bootstrap/';
...
gulp.task('bootstrap', function () {
    'use strict';
    gulp.src(sass_bootstrap_in)
       .pipe(gulp.dest(sass_bootstrap_out));
});
...
gulp.task('default', ['sass', 'uglify', 'imagemin', 'AdminLTE','font', 'bootstrap']);
